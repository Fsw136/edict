...
OFFICIALS = [
    {'id':'taizi',   'label':'总裁办','role':'总裁办主任','emoji':'🏢','rank':'高管'},
    {'id':'zhongshu','label':'PMO',   'role':'PMO总监',   'emoji':'📊','rank':'总监'},
    {'id':'menxia',  'label':'风控部','role':'风控总监',  'emoji':'🛡️','rank':'总监'},
    {'id':'shangshu','label':'调度中心','role':'运营总监','emoji':'🔀','rank':'总监'},
    {'id':'libu',    'label':'公关部','role':'公关总监',  'emoji':'📝','rank':'部门长'},
    {'id':'hubu',    'label':'财务部','role':'财务总监',  'emoji':'📈','rank':'部门长'},
    {'id':'bingbu',  'label':'运维部','role':'运维总监',  'emoji':'🛡️','rank':'部门长'},
    {'id':'xingbu',  'label':'QA部',  'role':'QA总监',    'emoji':'🧪','rank':'部门长'},
    {'id':'gongbu',  'label':'研发部','role':'研发总监',  'emoji':'💻','rank':'部门长'},
    {'id':'libu_hr', 'label':'HR部',  'role':'HR总监',    'emoji':'👥','rank':'部门长'},
    {'id':'zaochao', 'label':'研究员','role':'行业研究员','emoji':'📰','rank':'专家'},
]
...
def get_task_stats(org_label, tasks):
    ...
    participated = []
    for t in tasks:
        if not t['id'].startswith('REQ'): continue
