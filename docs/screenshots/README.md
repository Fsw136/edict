...
| 文件名 | 内容 | 对应面板 |
|--------|------|---------|
| `01-kanban-main.png` | 需求单看板总览 | 📋 需求单看板 |
| `02-monitor.png` | 省部调度 | 🔭 省部调度 |
| `03-task-detail.png` | 任务流转详情（点击任务卡片展开） | 📋 需求单看板 → 详情 |
| `04-model-config.png` | 模型配置面板 | ⚙️ 模型配置 |
| `05-skills-config.png` | 技能配置面板 | 🛠️ 技能配置 |
| `06-official-overview.png` | 高管总览（12 位 Agent） | 👥 高管总览 |
| `07-sessions.png` | 小任务 / 会话 | 💬 小任务 |
| `08-memorials.png` | 结案报告阁 | 📜 结案报告阁 |
| `09-templates.png` | 需求模板库（任务模板） | 📜 需求模板库 |
| `10-morning-briefing.png` | 行业早报 | 📰 行业早报 |
| `11-ceremony.png` | 晨会动画动画 | 开场动画 |
