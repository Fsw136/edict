...
企业中枢现已支持从网上连接和增补 skills 资源，无需手动复制文件。支持从以下来源获取：
...
- `sourceUrl` (string, 必需): 远程 URL 或本地文件路径
  ...
  - 本地: `file:///home/user/skills/code_review.md` 或 `/home/user/skills/code_review.md`
...
```json
{
  ...
  "localPath": "/home/user/.openclaw/workspace-zhongshu/skills/code_review/SKILL.md",
  "size": 2048,
...
|-----------|------|----------|--------|
| `code_review` | 代码审查（支持 Python/JS/Go） | 运维部/QA部 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/code_review/SKILL.md |
| `api_design` | API 设计审查 | 运维部/研发部 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/api_design/SKILL.md |
| `security_audit` | 安全审计 | QA部 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/security_audit/SKILL.md |
| `data_analysis` | 数据分析 | 财务部 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/data_analysis/SKILL.md |
| `doc_generation` | 文档生成 | 公关部 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/doc_generation/SKILL.md |
| `test_framework` | 测试框架设计 | 研发部/QA部 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/test_framework/SKILL.md |
